...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m src.scripts.empirical_benchmark.covariate_shift_summary outputs/empirical_benchmark/results/logistic/wbc.csv
  python -m src.scripts.empirical_benchmark.covariate_shift_summary outputs/empirical_benchmark/results/logistic/*.csv
  python -m src.scripts.empirical_benchmark.covariate_shift_summary outputs/empirical_benchmark/results/logistic/*.csv --format csv
        """,
    )
