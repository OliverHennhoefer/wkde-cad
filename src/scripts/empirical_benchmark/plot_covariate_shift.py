...
from .covariate_shift import fit_propensity_model, rejection_sample
from .utils.data_loader import load
from .utils.registry import get_dataset_enum
...
def main() -> None:
    ...
    for dataset in tqdm(datasets, desc="Covariate-shift plots", unit="dataset"):
