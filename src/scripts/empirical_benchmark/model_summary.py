...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m src.scripts.empirical_benchmark.model_summary outputs/empirical_benchmark/model_selection/breastw.csv
  python -m src.scripts.empirical_benchmark.model_summary outputs/empirical_benchmark/model_selection/*.csv --metric prauc
  python -m src.scripts.empirical_benchmark.model_summary outputs/empirical_benchmark/model_selection/breastw.csv --format csv
        """,
    )
